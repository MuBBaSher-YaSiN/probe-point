...
type TooltipExtraProps = {
  ...
  nameKey?: string
  labelKey?: string
  /** Force color for the indicator swatch */
  color?: string
}
...
>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      const [item] = payload as TooltipPayload<ValueType, NameType>[]
    ...
    const items = payload as TooltipPayload<ValueType, NameType>[]
            ...
            return (
              ...
              >
                {formatter && item?.value !== undefined && item.name ? (
                  // preserve user formatter API surface
                  <>
                    {
                      formatter(
                        item.value,
                    ...
                    {itemConfig?.icon ? (
                      ...
                      !hideIndicator && (
                        <div
                          ...
                          style={
                            {
                              // CSS variables must be cast for TS
...
function getPayloadConfigFromPayload(
  config: ChartConfig,
  payload: TooltipPayload<ValueType, NameType> | LegendPayload | any,
  key: string
) {
